  ...
  <ul class="nav" ng-show="!graphOnly()">
    ...
    <li class="menuButton dropdown">
      ...
      <ul>
        ...
        <li class="menuButton"><a class="link_with_params" href="${resource(dir: 'dashboard', file: 'detail')}#showResourceGroups=true&{{getTimeParams()}}" ng-click="reload()">Details With ${ReaderConfig.getInstance().resourceGroupName}s</a></li>
        </g:if>
      </ul>
    </li>
    <li class="menuButton dropdown">
    ...
    <li class="menuButton dropdown">
      ...
      <ul>
        <li class="menuButton"><a class="" href="${resource(dir: 'dashboard', file: 'breakdown')}#groupBy=ApplicationGroup&{{getTimeParams()}}" ng-click="reload()">By ${ReaderConfig.getInstance().applicationGroupName}</a></li>
        <li class="menuButton"><a class="" href="${resource(dir: 'dashboard', file: 'breakdown')}#{{getTimeParams()}}" ng-click="reload()">By ${ReaderConfig.getInstance().resourceGroupName}</a></li>
        <li class="menuButton"><a class="" href="${resource(dir: 'dashboard', file: 'editappgroup')}" ng-click="reload()">Create New ${ReaderConfig.getInstance().applicationGroupName}</a></li>
      </ul>
    </li>
    </g:if>
  </ul>
